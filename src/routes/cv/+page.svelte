...
<div class="space-y-16">
	<div>
		...
		<div class="grid max-md:grid-cols-1 md:grid-cols-3 md:space-x-8 max-md:space-y-8">
			...
			<div class="col space-y-4">
				...
				<p>
					Throughout this degree, I've improved on generating, developing, and materializing ideas,
					concepts, and graphics for complex communication programs. I acquired technical
					capabilities and skills as well as the correct use of methods and processes associated
					with Graphic Design. This year I am focusing on infographic design, art direction, and app
					design.
				</p>
			...
			<div class="space-y-4">
				...
				<p>
					This two-year vocational program focused on design and development skills to assist in the
					creation and upkeep of multimedia and web-based products.
				</p>
				<p class="font-light mt-2 opacity-70">
	...
	<div class="space-y-4">
		...
		<div class="grid max-md:grid-cols-1 md:grid-cols-3 md:space-x-8 max-md:space-y-4">
			...
			<div>
				<p class="text-lg italic mb-1">Crowdfunding Leadership, 2018</p>
				<p>
					Spearheaded a successful crowdfunding initiative to raise funds for animal shelter Finca
					Arkadia, surpassing the initial fundraising goal 2.3 times.
				</p>
			</div>
			<div>
				<p class="text-lg italic mb-1">Academic Recognition, 2021</p>
				<p>
					Received an Honorable Mention for my Web and Multimedia final project. Additionally,
					honored with the Extraordinary Prize for Professional Artistic Education in Plastic Arts
					and Design.
				</p>
			</div>
		</div>
	...
	<div class="grid max-md:grid-cols-1 md:grid-cols-3 md:space-x-8 max-md:space-y-12">
		...
		<div class="space-y-4">
			...
			<div>
				<p class="text-lg italic mb-1">Spanish</p>
				<p>Native or bilingual proficiency</p>
			</div>
			<div>
				<p class="text-lg italic mb-1">English</p>
				<p>Native or bilingual proficiency</p>
			</div>
			<div>
				<p class="text-lg italic mb-1">Swedish</p>
				<p>Native or bilingual proficiency</p>
			</div>
		</div>
